        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            <BlurFade key={index} delay={0.2 + index * 0.1}>
              <MagicCard className="p-6 text-center items-center justify-center border-0 bg-card/50 backdrop-blur-sm">
...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-grid-white/[0.02] bg-grid-pattern z-20"></div>
      ...
      <div className="relative z-30 max-w-4xl mx-auto px-4 sm:px-8 text-center">
        ...
        <BlurFade delay={0.4}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/resources">
              <Button size="lg" variant="outline" className="border-primary-foreground bg-primary-foreground/10 text-primary-foreground hover:bg-primary-foreground hover:text-primary px-8 py-4 text-lg font-semibold rounded-full backdrop-blur-sm">
