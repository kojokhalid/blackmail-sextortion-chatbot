...
const formSchema = z.object({
  ...
  issues_encountered: z.string().min(2, {
    message: "Issues encountered must be at least 2 characters.",
  }),
  specific_feedback: z.string().min(2, {
    message: "Specific feedback must be at least 2 characters.",
  }),
  task_completion: z.string().min(2, {
    message: "Task completion must be atleast least 2 characters.",
  }),
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        />
        {/* formfield for rating */}
        <FormField
          control={form.control}
          name="rating"
          render={({ field }) => (
            <FormItem className="space-y-3">
              <FormLabel>How satisfied are you rating from 1-5 ?</FormLabel>
              <FormControl>
                <RadioGroup
                  onValueChange={field.onChange}
                  defaultValue={field.value}
