                ...
                >
                  <ArrowUp
                    className={`text-white rounded-full p-2 ${
                      isDisabled || isLoading ? "bg-slate-400" : "bg-mblue"
                    }`}
                    size={40}
                  />
                </button>
      ...
      <div className="flex lg:justify-center lg:items-center">
        ...
        <div className=" flex flex-1 m-4 justify-center items-center">
          <div className="fixed p-4 bottom-0 text-slate-400">
            <p className="text-xs">
              © 2025 Safeguard Chatbot. All Rights Reserved.
This is a beta version of Safeguard Chatbot and is subject to change.
            </p>
          </div>
        </div>
      </div>
